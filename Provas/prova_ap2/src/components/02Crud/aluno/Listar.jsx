        ...
        <>
            ...
            <TableContainer component={Paper} sx={{ mt: 2, mb: 4 }}>
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                                    ...
                                    if(aluno.ira < media()){
                                        return (
                                            <StyledTableRow key={aluno._id}>
                                                <StyledTableCell>{id}</StyledTableCell>
                                                <StyledTableCell sx={{color: "red"}}>{aluno.nome}</StyledTableCell>
                                        ...
                                        return (
                                            <StyledTableRow key={aluno._id}>
                                                <StyledTableCell>{id}</StyledTableCell>
                                                <StyledTableCell sx={{color: "green"}}>{aluno.nome}</StyledTableCell>
                                                <StyledTableCell>{aluno.curso}</StyledTableCell>
                                                <StyledTableCell>{aluno.ira}</StyledTableCell>
                                                <StyledTableCell>
                                                    <Box sx={{display:"flex",justifyContent:"center"}}>
                    ...
                    <TableHead>
                        <StyledTableRow>
                            <StyledTableCell colSpan={5} align="center">Média dos IRAs</StyledTableCell>
                        </StyledTableRow>
                    </TableHead>
                    <TableBody>
                        <StyledTableRow
                        ...
                        >
                            <StyledTableCell colSpan={5} align="center">{media().toFixed(2)}</StyledTableCell>
                        </StyledTableRow>
                    </TableBody>
                </Table>
            </TableContainer>
